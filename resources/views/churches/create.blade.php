...
@section('content')
	<div class="row">
	    <div class="col-lg-12 margin-tb">
	        ...
	        <div class="pull-right">
	            <a class="btn btn-primary" href="{{ route('church.index') }}"> Back</a>
	        </div>
	    </div>
	</div>
	@if (count($errors) > 0)
	...
	@endif
	{!! Form::open(array('route' => 'church.store','method'=>'POST')) !!}
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('user_id', null, array('placeholder' => 'Pastor','class' => 'form-control')) !!}
            </div>
        </div>
