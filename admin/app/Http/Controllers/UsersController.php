...
class UsersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $relations = [
            'roles' => \App\Role::get()->pluck('title', 'id')->prepend('Please select', ''),
            'cells' => \App\Cell::where('user_id', $id)->get(),
            'testimonies' => \App\Testimony::where('user_id', $id)->get(),
            'partnerships' => \App\Partnership::where('user_id', $id)->get(),
            'churches' => \App\Church::where('user_id', $id)->get(),
        ];
